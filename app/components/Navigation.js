    ...
    renderProfileNav() {
        ...
        return (
            <nav className={ block('links', ['profile']) }>
                ...
                <NavLink base={ block('link') } to="/create">Create</NavLink>
                <NavLink base={ block('link') } to="/search">Search</NavLink>
            </nav>
        );
    },
    ...
    renderProjectNav() {
        ...
        return (
            <nav className={ block('links', ['project']) }>
                <NavLink base={ block('link') } to={ `/project/${id}` }>Dashboard</NavLink>
                <NavLink base={ block('link') } to={ `/project/${id}/entry` }>New Entry</NavLink>
            {/*
                <NavLink base={ block('link') } to={ `/project/${id}/members` }>Members</NavLink>
                <NavLink base={ block('link') } to={ `/project/${id}/rings` }>Rings</NavLink>
                <NavLink base={ block('link') } to={ `/project/${id}/export` }>Export Data</NavLink>
            */}
            </nav>
        );
    },
